        ...
        <div className="main-content">
          ...
          <div className="calculator-card">
            <div className="mac-header">
              ...
              <div className="mac-title">CALORIE CALCULATOR</div>
            </div>
