        ...
        <div className="main-content">
          ...
          <div className="calculator-card">
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <div className="mac-title" style={{ marginLeft: '12px' }}>GFR CALCULATOR</div>
            </div>
            <EmbedButton slug="gfr-calculator" />
          </div>
