        ...
        <div className="main-content">
          <div className="calculator-card">
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <div className="mac-title" style={{ marginLeft: '12px' }}>LEAN BODY MASS</div>
            </div>
            <EmbedButton slug="lean-body-mass-calculator" />
          </div>
