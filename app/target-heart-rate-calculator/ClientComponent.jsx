        ...
        <div className="main-content">
          ...
          <div className="calculator-card">
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <div className="mac-title" style={{ marginLeft: '12px' }}>TARGET HEART RATE CALCULATOR</div>
            </div>
            <EmbedButton slug="target-heart-rate-calculator" />
          </div>
