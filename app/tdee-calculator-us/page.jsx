...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      'Free TDEE calculator for US users. Calculate your maintenance calories, BMR, BMI, and macros in lbs/inches.',
  ...
  twitter: {
    ...
    title: 'TDEE Calculator USA — Daily Calories in Pounds & Inches',
    description: 'Free TDEE calculator for the United States. Pounds, inches, Mifflin-St Jeor. No signup required.',
