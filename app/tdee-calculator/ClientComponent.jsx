      ...
      <div className="container tool-layout-container" style={{ paddingTop:'2rem', paddingBottom:'4rem' }}>
        ...
        <div className="calculator-card">
          <div className="mac-header">
            ...
            <div className="mac-title">TDEE & Macros</div>
          </div>
        ...
        <div className="article-section">
          ...
          {/* Related tools */}
          <div style={{ background:'var(--bg)', border:'1px solid var(--border)', borderRadius:'var(--r-lg)', padding:'1.5rem', marginTop:'2rem' }}>
            ...
            <div style={{ display:'flex', flexWrap:'wrap', gap:'10px' }}>
              {[
                ...
                <Link key={to} href={to} className="btn outline" style={{ width:'auto', padding:'8px 16px', fontSize:'.85rem' }}>{l}</Link>
              ))}
            </div>
          </div>
