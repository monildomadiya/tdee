        ...
        <div className="main-content">
          <div className="calculator-card">
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <div className="mac-title" style={{ marginLeft: '12px' }}>HYDRATION CALCULATOR</div>
            </div>
            <EmbedButton slug="water-intake-calculator" />
          </div>
                    ...
                    {!result ? (
                      ...
                      <div style={{ textAlign:'center', animation:'popIn .4s ease both', width:'100%' }}>
                        ...
                        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'10px', marginTop:'1.5rem' }}>
                          <div style={{ background:'var(--blue-light-alt)', border:'1px solid #bfdbfe', padding:'1rem', borderRadius:'var(--r-md)', textAlign:'center' }}>
